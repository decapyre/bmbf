/*
* http://foundation.zurb.com/forum/posts/18225-magellan--side-nav-destination-is-off
* added fix from http://foundation.zurb.com/forum/posts/13831-fixed-sidebar
*/
  ...
  Foundation.libs['magellan-expedition'] = {
    ...
    events : function () {
      ...
      S(self.scope)
        ...
        .on('click.fndtn.magellan', '[' + self.add_namespace('data-magellan-arrival') + '] a[href^="#"]', function (e) {
          ...
          $('html, body').stop().animate({'scrollTop': scroll_top}, 0, function () {
    ...
    set_expedition_position : function() {
      ...
      $('[' + this.attr_name() + '=fixed]', self.scope).each(function(idx, el) {
        ...
        if(top_offset > 1000) {
          top_offset = top_offset/2 + settings.threshold;
         // top_offset = expedition.data('magellan-top-offset') + settings.threshold;
        }
